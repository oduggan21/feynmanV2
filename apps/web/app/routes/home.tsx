      ...
      <div className="w-full max-w-3xl">
        <div className="mb-10 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            {'"The best way to learn is to teach."'} Explain a topic out loud;
            your curious AI student will ask questions and help you discover
            gaps.
          </p>
        </div>
        ...
        <Card className="shadow-md">
          <CardHeader className="space-y-2">
            ...
            <CardDescription className="text-center">
              Enter a topic and begin a session. We’ll mock the AI interactions
              for now.
            </CardDescription>
          </CardHeader>
          <CardContent>
